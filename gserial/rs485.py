...
class RS485(gserial.Serial):
    ...
    def write(self, b):
        ...
        if self._alternate_rs485_settings is not None:
            ...
            if self._alternate_rs485_settings.delay_before_tx is not None:
                gevent.sleep(self._alternate_rs485_settings.delay_before_tx)
            ...
            if self._alternate_rs485_settings.delay_before_rx is not None:
                gevent.sleep(self._alternate_rs485_settings.delay_before_rx)
    ...
    def rs485_mode(self):
        ...
        See gserial.rs485.RS485Settings for more info about the value.
        """
